...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    func updateTipTotals() {
        ...
        let percent = (tipPercent.text as NSString).floatValue/100
        ...
        if numberOfPeople != nil {
            if numberOfPeople! > 0 {
                ...
                let alert=UIAlertController(title: "Error!", message: "Please enter a number greater than 0", preferredStyle: UIAlertControllerStyle.Alert)
